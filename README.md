...
- **Autenticação de usuários**, incluindo login de administrador, com **senhas criptografadas**.
- **Armazenamento de usuários** em um banco de dados seguro.
- **Indicadores de negócio** calculados a partir de dados simulados usando **Pandas**.
- **Dashboards interativos** construídos com **Matplotlib / Pyplot**.
- Tudo integrado em uma interface web intuitiva e responsiva.
